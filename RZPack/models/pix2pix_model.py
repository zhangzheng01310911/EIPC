...
from RZPack.util.image_pool import ImagePool
from RZPack.util import util
...
class Pix2PixModel(BaseModel):
    ...
    def colorize_input(self, grayscales, color_hints, masks):
        color_class, color_reg = self.netG(grayscales, color_hints, masks)
        return color_reg
