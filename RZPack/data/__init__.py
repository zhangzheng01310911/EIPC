...
from RZPack.data.base_data_loader import BaseDataLoader
from RZPack.data.base_dataset import BaseDataset
...
def find_dataset_using_name(dataset_name):
    ...
    # will be imported.
    dataset_filename = "RZPack.data." + dataset_name + "_dataset"
